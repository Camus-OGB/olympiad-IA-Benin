  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 relative bg-slate-50">
        <Link href="/connexion" className="absolute top-8 left-8 inline-flex items-center text-gray-500 hover:text-ioai-dark-blue transition-colors text-sm font-bold group">
