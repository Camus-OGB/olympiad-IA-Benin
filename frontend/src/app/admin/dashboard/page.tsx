    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
          ...
          <p className="text-sm text-gray-500">Profils validés</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              { label: 'Profils validés', count: stats?.verifiedCandidates ?? 0, color: 'bg-green-500', width: stats?.totalCandidates ? `${(stats.verifiedCandidates / stats.totalCandidates * 100)}%` : '0%' },
